                            ...
                            <div className="row row-cols-4 ">
                                ...
                                (
                                    <Card class="bg-gray-750"
                                        ...
                                        <img style={{ width: "100%" }} class="hover:animate-pulse max-w-sm h-auto rounded-lg transition-all mx-auto duration-300 cursor-pointer filter grayscale hover:grayscale-0" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/content/content-gallery-3.png" alt="image description"></img>
